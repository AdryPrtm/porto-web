...
export const CertificateFeatures = () => {
  ...
  return (
    <div className="w-full flex flex-col space-y-4">
      ...
      <div className="border border-gray-800 flex flex-col space-y-6 p-6 rounded-xl">
        ...
        <a
          href="https://www.linkedin.com/in/adryprtm/details/certifications/"
          target="_blank"
          rel="noopener noreferrer"
          className="border border-gray-800 px-4 py-2 rounded-lg hover:bg-white hover:text-black hover:font-bold transition-colors duration-300 flex justify-center"
        >
